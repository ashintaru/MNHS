...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title> Import Class List | <?php echo $title; ?></title>
            ...
            <a href="ann.php" class="nav-link  ">
             <i class="nav-icon fa-solid  fa-bullhorn"></i>
              <p>  
                 ...
                 <li class="nav-item  ">
            <a href="import.php" class="nav-link    active text-white">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> Import Class List </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Import Class List </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<form enctype="multipart/form-data" method="post" role="form">
    ...
    <button type="submit" class="btn btn-warning text-bold text-white" name="submit" value="submit"><i class="fa-solid fa-cloud-arrow-up"></i> Upload</button>
</form>
</div>
  ...
  //   $database = 'mnhs';
    ...
    if (isset($_FILES['file']['tmp_name']) && $_FILES['file']['tmp_name']) {
        ...
        while (($filesop = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $contact = $filesop[3];
            $email = $filesop[4];
            $grade_level = $filesop[5];
            $section = $filesop[6];
            $pid = $filesop[7];
            
            // Prepare and execute the SQL statement
        $sql = "INSERT INTO student (id,firstname, lastname,contact,email, grade_level, section,pid, sy) 
        VALUES (?, ?, ?, ?, ?,?, ?, ?, ?)";
$stmt = mysqli_prepare($conn, $sql);
mysqli_stmt_bind_param($stmt, 'ssssssss', $id, $firstname,$lastname,$contact,$email, $grade_level, $section, $pid, $sy);

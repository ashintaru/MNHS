...
<button type="button"  data-toggle="modal" data-target="#addmenu" class="btn btn-success float-right"><i class="fa-solid fa-scroll"></i> Add Announcements</button>

</div>

<div class="card-body">
<table id="example1" class="table  datatables-responsive table-bordered  table-hover table-striped">
<thead>
<tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title text-danger text-bold" id="exampleModalLabel">         <i class="fa-solid fa-trash"></i>  Delete Announcements</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
 <form method="POST" action="ann.php" enctype="multipart/form-data">

                
                  <div class="form-group col-6">
                    <label for="text">Title<text class="text-danger">*</text></label>
                    <input type="text" class="form-control" name="title" value="'.$row['title'].'" required placeholder="Enter Title">
                  </div>

               
                  <div class="form-group col-12">
                    <label for="text">Details<text class="text-danger">*</text></label>
                    <textarea   class="form-control" name="details" placeholder="Enter Details">'.$row['details'].'</textarea>
                  </div>
...
<div class="modal fade" id="edit'.$row['id'].'"   aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-bold" id="exampleModalLabel"><i class="fa-solid fa-edit"></i> Update Announcements</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit'.$row['id'].'" name="update_ann" onclick="submit'.$row['id'].'()" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Save Update</button>
         </form>
      </div>
    </div>
  </div>
...
$sql = "DELETE FROM ann WHERE id='$id'";
...
if ($conn->query($sql) === TRUE) {
  ...
  echo '  <meta http-equiv="refresh" content="1.5; URL=ann.php" />';
...
<div class="modal fade" id="addmenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-bold" id="exampleModalLabel"><i class="fa-solid fa-bullhorn"></i> Add New Announcement</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row">
                  ...
                  <div class="form-group col-6">
                    <label for="text">Title<text class="text-danger">*</text></label>
                    <input type="text" class="form-control" name="title" required placeholder="Enter Announcement">
                  </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" id="id1" name="add_ann" onclick="submit()" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Save</button>
      </div>
    </div>
  </div>
</div>
...
if(isset($_POST['add_ann']))
  {
    ...
    $sql = "INSERT INTO ann (title, details, month, day, year)
VALUES ('$title', '$details', '$month', '$day', '$year')";
...
if(isset($_POST['update_ann']))
  {
    ...
    $sql = "UPDATE ann SET title='$title', details='$details' WHERE id='$update_id'";

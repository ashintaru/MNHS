  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="m-0">Students Grades School Academic Year : <?php echo $_GET['sy']; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Students Grades</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card-body">
  ...
  <div class="form-group   col-3">
    ...
    <select id="sy" onchange="sy()" class="form-control" name="year" required>
        <option   disabled selected>Selected Year : <?php echo $_GET['sy']; ?></option>
...
<script type="text/javascript">
  ...
  function  sy(){
    ...
    var sy = document.getElementById("sy").value;
       ...
       window.location="filter_grade.php?sy="+sy;
  }
...
$filter_sy = $_GET['sy'];
$sql = "SELECT * FROM student where sy='$filter_sy'    order by id DESC";
$result = $conn->query($sql);
...
<td>
<a href="student_grades.php?id='.$row['id'].'&sy='.$sy.'"  class="btn mr-2 btn-primary" >     <i class="fa-solid fa-eye "></i>   </a>
    ...
    <div class="modal-content">
      ...
      <div class="row">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control" value="'.$row['contact'].'" required name="contact" placeholder="Enter Contact #" >
                  </div>

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Students Grades School Academic Year : <?php echo $sy; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$sql = "SELECT * FROM student where sy='$sy'   order by id DESC";
$result = $conn->query($sql);
...
<td > '.$row['section'].'</td>
<td class="text-bold text-orange" > '.$py.' - '.$year.'</td>

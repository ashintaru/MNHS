...
$sql = "SELECT * FROM student where grade_level='$grade_level' and section='$section' and sy='$sy' ";
...
if ($result->num_rows > 0) {
  ...
  $id = $row['id'];
    ...
    echo '  <a class="affan-element-item" href="teacher_view_student.php?section='.$section.'&grade_level='.$grade_level.'&subject='.$subject.'&sid='.$id.'">

        <text> [ <i class="fa-regular fa-id-badge"></i> '.$row['id'].'] '.$row['firstname'].' '.$row['lastname'].' </text> 

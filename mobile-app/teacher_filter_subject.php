    ...
    <div class="container">
      ...
      <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0"><?php echo $_GET['grade_level']; ?> <?php echo $_GET['section']; ?></h6>
        </div>
  ...
  <div class="page-content-wrapper py-3">
    <div class="container">
      ...
      <div class="card user-data-card">
        <div class="card-body">
          <form method="GET" action="teacher_filter_subject.php">
    ...
    echo ' <option value="'.$row['section'].'"> '.$row['section'].'</option>   
              ...
              ';
               ...
               ?>
                ...
                <button class="btn mb-2 btn-sm btn-primary"><i class="fa-solid fa-filter"></i> Apply Filter</button>
              </form>
           ...
           <table class="w-100" id="dataTable">
            ...
            <tbody>
              ...
              <?php
              $teacher = ''.$_SESSION['firstname'].' '.$_SESSION['lastname'].'';
              $sql = "SELECT * FROM subject where teacher='$teacher' and grade_level='$grade_level' and section='$section' group by subject ";
$result = $conn->query($sql);

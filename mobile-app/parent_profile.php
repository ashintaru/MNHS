...
$sql = "UPDATE account SET firstname='$firstname', lastname='$lastname', contact='$contact', email='$email'  WHERE id = '$id' ";
...
if ($result->num_rows > 0) {
  ...
  ?>
          ...
          <form action="parent_profile.php" method="POST">
            <div class="form-group mb-3">
              <label class="form-label" for="Username">Username</label>
              <input class="form-control" name="username" readonly type="text"  value="<?php echo $username; ?>" placeholder="Username">
            </div>

...
$sql = "SELECT * FROM subject where teacher='$teacher'";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    $sql2 = "SELECT * FROM student where grade_level='$grade_level' and section='$section'";
...
if ($result2->num_rows > 0) {
  ...
  while($row2 = $result2->fetch_assoc()) {
    ...
    $sql = "SELECT  id from subject where teacher ='$teacher' ";
          ...
          <div class="row g-3">
            <div class="col-6">
              <div class="feature-card mx-auto text-center">
                <div class="card mx-auto fw-bold ">
               <?php echo number_format($teacher);  ?>
                </div>
                <p class="mb-0 text-dark fw-bold">Total Subjects</p>
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="feature-card mx-auto text-center">
               ...
               <?php echo $total_student;  ?>
                ...
                <p class="mb-0 text-dark fw-bold">Total Students</p>
              </div>
            </div>

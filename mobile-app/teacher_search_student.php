        ...
        <div class="element-heading-wrapper">
         <i class="fa-solid fa-address-book"></i>
          <div class="heading-text">
            <h6 class="mb-1">My Subjects</h6>
            <span>Subjects assigned to you.</span>
          </div>
        </div>
      </div>
...
if ($result4->num_rows > 0) {
 ...
 if($grades == ''){
   echo ' <div class="alert custom-alert-2 alert-danger alert-dismissible fade show" role="alert">
            <i class="bi bi-x-circle"></i>
          Input Grades is Disabled
...
$sql = "SELECT * FROM subject where teacher='$teacher' group by subject";
...
if($grades == 'on'){
  $href = 'teacher_student_list.php?section='.$section.'&grade_level='.$grade_level.'&subject='.$subject.'';
  $icon = '<i class="bi bi-caret-right-fill fz-12"></i>';
}



    $sql2 = "SELECT * FROM student where grade_level='$grade_level' and section='$section' group by grade_level,section ";
...
if ($result2->num_rows > 0) {
  ...
  while($row2 = $result2->fetch_assoc()) {
   ...
   echo '  <a class="affan-element-item" href="'.$href.'">
        <text><i class="fa-solid fa-book"></i> '.$subject.' </text> 
        '.$icon.'
      </a>';

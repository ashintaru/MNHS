...
<body onload="window.print()" lang=EN-PH style='word-wrap:break-word'>
...
<body onload="window.print()" class="page-break" lang=EN-PH style='word-wrap:break-word'>
...
$pe_average = $average;
 ...
 // Assuming these are your subject averages
$math_average = $average;
$english_average = $average;
$filipino_average = $average;
$science_average = $average;
$ve_average = $average; // (Values Education?)
$tle_average = $average; // (Technology and Livelihood Education)
$mapeh_average = $average; // (Music, Arts, PE, and Health)
$ma_average = $average; // (Music & Arts?)
$pe_average = $average; // (Physical Education)

// Sum all subject averages
$total_sum = 
    $math_average + 
    $english_average + 
    $filipino_average + 
...
// Count the number of subjects (adjust if some are duplicates)
$number_of_subjects = 9; // math, english, filipino, science, ve, tle, mapeh, ma, pe

// Calculate the general average
$general_average = $total_sum / $number_of_subjects;
...
?>
 ...
 <tr>
  ...
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  padding:0in 5.75pt 0in 5.75pt'>
  <p class=MsoNoSpacing><span style='font-size:9.0pt;font-family:"Bookman Old Style",serif'>&nbsp; <?php echo $general_average; ?></span></p>
  </td>
  <td width="17%" valign=top style='width:17.94%;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  padding:0in 5.75pt 0in 5.75pt'>
  <p class=MsoNoSpacing><span style='font-size:9.0pt;font-family:"Bookman Old Style",serif'>&nbsp; <?php echo $ge_text; ?> </span></p>
  </td>
 </tr>
</table>

...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title> Manage Section List | <?php echo $title; ?></title>
            ...
            <a href="subject.php" class="nav-link    ">
             <i class="nav-icon fa-solid fa-list"></i>
              <p>  
               ...
               <li class="nav-item  ">
            <a href="section.php" class="nav-link  text-white active ">
...
<button type="button"  data-toggle="modal" data-target="#addmenu" class="btn btn-info float-right"><i class="fa-solid fa-plus"></i> Add New Section</button>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    $section = $row['section'];
     ...
     $sql2 = "SELECT  id from student where section='$section' ";
    if ($result2 = mysqli_query($conn, $sql2)) {
    $student = mysqli_num_rows( $result2 );
} 


     $sql2 = "SELECT  id from subject where section='$section' ";
    if ($result2 = mysqli_query($conn, $sql2)) {
    $subject = mysqli_num_rows( $result2 );
} 
...
<td class="text-bold h3 text-orange"> '.$row['section'].' </td>
<td > '.$student.' </td>
<td > '.$subject.' </td>
<td >  '.$subject.'  </td>
...
<div class="modal fade" id="del'.$row['id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title text-danger text-bold" id="exampleModalLabel">         <i class="fa-solid fa-trash"></i>  Delete Section </h5>
 ...
 <form method="POST" action="section.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group ">
                    ...
                    <input readonly type="text" class="form-control" name="section" value="'.$row['section'].'" required  >
                  </div>
...
<div class="modal fade" id="edit'.$row['id'].'"   aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title text-bold" id="exampleModalLabel"><i class="fa-solid fa-edit"></i> Update Section</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <form method="POST" action="section.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group  ">
                    <label for="text">Section<text class="text-danger">*</text></label>
                    <input type="text" class="form-control" name="section" value="'.$row['section'].'" required placeholder="Enter Section">
                  </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit'.$row['id'].'" name="update_section" onclick="submit'.$row['id'].'()" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Save Update</button>
         </form>
      </div>
    </div>
  </div>
...
if ($conn->query($sql) === TRUE) {
  ...
  echo '  <meta http-equiv="refresh" content="1.5; URL=section.php" />';
...
<div class="modal fade" id="addmenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog   modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title text-bold" id="exampleModalLabel"><i class="fa-solid fa-rectangle-list"></i> Add New Class Section</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row">
                  ...
                  <div class="form-group col-12">
                    <label for="text">Section<text class="text-danger">*</text></label>
                    <input type="text" class="form-control" name="section" required placeholder="Enter Class Section">
                  </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" id="id1" name="add_section" onclick="submit()" class="btn btn-success"><i class="fa-solid fa-floppy-disk"></i> Add Section</button>
      </div>
    </div>
  </div>
</div>
...
if(isset($_POST['add_section']))
  {
    ...
    $sql = "INSERT INTO section (section, month, day, year)
VALUES ('$section', '$month', '$day', '$year')";
...
if(isset($_POST['update_section']))
  {
    ...
    $sql = "UPDATE section SET section='$section' WHERE id='$update_id'";

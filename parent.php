...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title> Parents | <?php echo $title; ?></title>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-2 pb-1 mb-1 d-flex">
        ...
        <div class="info">
          ...
          <li class="nav-item">
            <a href="parent.php" class="nav-link text-white active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Parents</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<button type="button"  data-toggle="modal" data-target="#addmenu" class="btn btn-primary float-right"><i class="fa-solid fa-plus"></i> Add Parents</button>
...
$sql = "SELECT * FROM account where type = 'Parent'  order by id DESC";
...
<td class="text-bold text-orange"> '.$row['id'].' </td>
<td > '.$row['firstname'].'</td>
<td > '.$row['lastname'].'</td>
<td > '.$row['email'].'</td>
<td > '.$row['contact'].'</td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title text-danger text-bold" id="exampleModalLabel">         <i class="fa-solid fa-trash"></i>  Delete Parents Information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
 <form method="POST" action="parent.php" enctype="multipart/form-data">
...
<div class="modal fade" id="edit'.$row['id'].'"   aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title text-bold" id="exampleModalLabel"><i class="fa-solid fa-user-shield"></i> Update Parents Information</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row">
                ...
                <div class="form-group col-6">
                  ...
                  <div class="form-group col-6">
                  <label >Contact #<text class="text-danger">*</text></label>
                  <input type="number" class="form-control" name="contact" value="'.$row['contact'].'" required placeholder="Enter Contact #"  >
                </div>
                ...
                <div class="form-group col-6">
                  ...
                  <input type="password" class="form-control" id="password'.$row['id'].'" value="'.$row['password'].'" name="password" required placeholder="Enter Password"  >
                </div>


                <div class="form-group col-6">
                  <label >Confirm Password<text class="text-danger">*</text></label>
                  <input type="password" class="form-control" id="confirm_password'.$row['id'].'" value="'.$row['password'].'" name="password" required placeholder="Enter Password"  >
                </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit'.$row['id'].'" name="update_parent" onclick="submit'.$row['id'].'()" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Save Update</button>
         </form>
      </div>
    </div>
  </div>
...
if ($conn->query($sql) === TRUE) {
  ...
  echo '  <meta http-equiv="refresh" content="1.5; URL=parent.php" />';
...
<div class="modal fade" id="addmenu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title text-bold" id="exampleModalLabel"><i class="fa-solid fa-user-shield"></i> Add New Parents</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
    ...
    <div class="input-group">
        ...
        <input type="tel" class="form-control" name="contact" required 
               ...
               maxlength="10" minlength="10" title="Enter a 10-digit phone number">
                ...
                <div class="form-group col-6">
                  <label >Confirm Password<text class="text-danger">*</text></label>
                  <input type="password" class="form-control" id="confirm_password" name="password" required placeholder="Enter Password"  >
                </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" id="id1" name="add_parent" onclick="submit()" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Save New Parents</button>
      </div>
    </div>
  </div>
</div>
...
if ($conn->query($sql) === TRUE) {
  ...
  position: "center",
  icon: "success",
  title: "Successfully Added Parents",
  showConfirmButton: false,
  timer: 1500
});
...
if(isset($_POST['update_parent']))
  {
    ...
    $sql = "UPDATE account SET firstname='$firstname', lastname='$lastname', email='$email', contact='$contact', password='$password', username='$username', status='$status' WHERE id='$update_id'";
